...
{
    public partial class FrmYeniMusterics : Form
    {
        public FrmYeniMusterics()
        {
            InitializeComponent();
        }
        ...
        {
            int Ucret;
            DateTime KucukTarih = Convert.ToDateTime(dtpGirisTar.Text);
            DateTime BuyukTarih = Convert.ToDateTime(dtpCikisTar.Text);
        ...
        private void FrmYeniMusterics_Load(object sender, EventArgs e)
        {
            baglanti.Open();
...
//Data Source=LAPTOP-OR3T0EKC\SQLEXPRESS;Initial Catalog=AycicegiPansiyon;Integrated Security=True